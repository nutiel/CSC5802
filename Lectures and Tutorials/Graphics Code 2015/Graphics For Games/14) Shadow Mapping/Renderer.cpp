...
Renderer::Renderer(Window & parent) : OGLRenderer(parent) {
	camera = new Camera(0.0f, -8.0f, 0.0f, Vector3(-200.0f, 50.0f, 250.0f));
...
void Renderer::UpdateScene(float msec) {
	...
	light->SetPosition(Vector3(150.0f*cos(seconds/3000.0)-450.0f, 150.0f*sin(seconds/3000.0)+200.0f, 280.0f));
}
